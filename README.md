...
Excel Power Pivot was used to combine 8 million records from 150 files from kaggle and separate them into 2 different datasets, one for electricity and one for gas. A description for both [unedited](assets/ERD/unedited/README.md) and [edited](assets/ERD/edited/ERD_Dutch.png) data structure is as follows:
